...
public class CommonFunction {
    ...
    public static void sendTextByJS(WebDriver driver, String text, WebElement ele) {
        ele.click();
        JavascriptExecutor ex = (JavascriptExecutor) driver;
        ex.executeScript("arguments[0].value = '';", ele);
        ex.executeScript("arguments[0].value='" + text + "';", ele);
    ...
    public static void scrollOnElementToClick(WebDriver driver, WebElement element) {
  ...
  /*  public static void getShadowElementOnScreen(WebDriver driver,String cssSelector) throws InterruptedException {
    ...
    public static void waitForNextStep(WebDriver driver) {
    ...
    /**
     * @method To check wheather element is present or not
     */
    ...
    public static List<WebElement> getCustomisedWebElements(WebDriver driver, String stringXpath, String stringToAdd) {
        return driver.findElements(By.xpath(String.format(stringXpath, stringToAdd)));
    }
    ...
    public static WebElement getCustomisedWebElement(WebDriver driver, String stringXpath, String stringToAdd) throws InterruptedException {
        ...
        return driver.findElement(By.xpath(String.format(stringXpath, stringToAdd)));
    }

    /**
     * @method get WebElement returns Element on run time itself during execution
     */
    public static WebElement getWebElement(WebDriver driver, String stringXpath) throws InterruptedException {
        CommonFunction.waitForMinimalTime();
